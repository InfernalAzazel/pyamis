...
class Table2(AmisNode):
    ...
    - 默认值：暂无数据
    """
    rowSelection: SerializeAsAny[Optional["TableSelections2"]] = None
    """行相关配置"""
    rowClassNameExpr: Optional[Union[str, Template]] = None
    """行 CSS 类名，支持模版语法"""
    expandable: SerializeAsAny[Optional["TableExpandable2"]] = None
    """展开行配置"""
    ...
    """
    columns:  SerializeAsAny[Optional[List[Union["TableColumn2", SchemaNode]]]] = None
    """用来设置列信息"""
